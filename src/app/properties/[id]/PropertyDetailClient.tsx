        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              {property.platformEquityPercent > 0 && (
                <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20 mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <p className="font-semibold text-amber-400">{property.platformEquityPercent}%</p>
                    </div>
                    <div>
                      <p className="text-foreground-muted text-xs">Available for Investors</p>
                      <p className="font-semibold text-secondary">{100 - property.platformEquityPercent}%</p>
                    </div>
                  </div>
                </div>
              )}

              {property.fundingDeadline && property.status === "funding" && (
                <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/20 mb-6">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium text-purple-400">
                      {new Date(property.fundingDeadline).toLocaleDateString("en-US", {
                        month: "short",
                        day: "numeric",
                        year: "numeric",
                      })}
              ...
              {property.status === "funding" && (
                <>
                  <div className="mb-6">
                    <label className="block text-sm text-foreground-muted mb-2">Number of Tokens</label>
                    ...
                    {[10, 50, 100, 500].map((amount) => (
                      <button
                        ...
                        className={`flex-1 py-2 rounded-lg text-sm font-medium transition-colors ${
                          tokenAmount === amount ? "bg-accent text-background" : "glass-card hover:border-accent/40"
                        }`}
                      >
                        {amount}
                      </button>
              ...
              {!purchaseSuccess ? (
                ...
                <div className="text-center">
                  <motion.div
                    ...
                    className="w-20 h-20 rounded-full bg-linear-to-br from-emerald-400 to-cyan-400 flex items-center justify-center mx-auto mb-6"
                  >
